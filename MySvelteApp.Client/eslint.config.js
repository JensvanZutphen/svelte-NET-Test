...
const gitignorePath = fileURLToPath(new URL('./.gitignore',
    import.meta.url));
const tsconfigRootDir = fileURLToPath(new URL('.',
    import.meta.url));

export default ts.config({ ignores: ['api/**', 'src/lib/components/ui/**'] },
    ...
    ...svelte.configs.prettier, {
        ...
        languageOptions: {
            parserOptions: {
                project: [fileURLToPath(new URL('./tsconfig.eslint.json',
                    import.meta.url))],
                tsconfigRootDir,
