...
public static class TestData
{
    ...
    public static class Requests
    {
        public static class Authentication
        {
            ...
            public static RegisterRequest InvalidUsernameRequest => new()
            {
                Username = "us",
                Email = "test@example.com",
                Password = "ValidPassword123"
            ...
            public static RegisterRequest WeakPasswordRequest => new()
            {
                Username = "testuser",
                Email = "test@example.com",
                Password = "password"
            ...
            public static LoginRequest EmptyUsernameRequest => new()
            {
                Username = "",
                Password = "ValidPassword123"
            };
